...
var _validateComponentProp = _interopRequireDefault(
  require('./util/validateComponentProp')
)
...
var createConnectedFields = function createConnectedFields(structure) {
  ...
  var getSyncError = function getSyncError(syncErrors, name) {
    ...
    return (
      _plain['default'].getIn(syncErrors, name + '._error') ||
      _plain['default'].getIn(syncErrors, name)
    )
  }
    ...
    (function(_React$Component) {
      ...
      _proto.render = function render() {
        ...
        var _this$props4 = this.props,
          ...
          rest = (0, _objectWithoutPropertiesLoose2['default'])(_this$props4, [
            'component',
            'forwardRef',
            '_fields',
            '_reduxForm'
        ...
        var _Object$keys$reduce = Object.keys(_fields).reduce(function(
            accumulator,
            name
          ) {
            var connectedProps = _fields[name]

            var _createFieldProps = (0, _createFieldProps2['default'])(
                structure,
                name,
                (0, _extends2['default'])({}, connectedProps, rest, {
                  form: form,
              ...
              fieldProps = (0, _objectWithoutPropertiesLoose2['default'])(
                _createFieldProps,
                ['custom']
              )
        ...
        return _react['default'].createElement(
          component,
          (0, _extends2['default'])({}, props, custom)
        )
      }
