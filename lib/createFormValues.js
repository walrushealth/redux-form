        ...
        (function(_React$Component) {
          ...
          _proto.render = function render() {
            ...
            return _react['default'].createElement(
              Component, // so that the connected component updates props when sectionPrefix has changed
              (0, _extends2['default'])(
                {
          ...
          _proto.updateComponent = function updateComponent(props) {
            ...
            if (typeof resolvedFirstArg === 'string') {
              ...
              (_rest$reduce[resolvedFirstArg] = resolvedFirstArg),
              _rest$reduce))
            } else {
          ...
          _proto.setComponent = function setComponent() {
            ...
            var formValuesSelector = function formValuesSelector(_, _ref2) {
              ...
              return (0, _mapValues2['default'])(_this2._valuesMap, function(
                path
              ) {
                return getIn(
                  values,
                  (0, _prefixName['default'])(_this2.props, path)
                )
              })
            }

            this.Component = (0, _reactRedux.connect)(
              formValuesSelector,
              function() {
                return {}
              } // ignore dispatch
