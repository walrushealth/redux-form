...
var warnAndValidatePropType = _propTypes['default'].oneOfType([
...
var getFieldWarnAndValidate = function getFieldWarnAndValidate(prop, name) {
  return Array.isArray(prop) || typeof prop === 'function'
    ? prop
    : (0, _get['default'])(prop, name, undefined)
}
    ...
    (function(_Component) {
      ...
      _proto.registerFields = function registerFields(names) {
        ...
        names.forEach(function(name) {
          return register(
            (0, _prefixName['default'])(props, name),
            'Field',
            function() {
