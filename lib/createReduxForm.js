...
var arrayInsert = _actions['default'].arrayInsert,
  ...
  formActions = (0, _objectWithoutPropertiesLoose2['default'])(
    _actions['default'],
    [
      'arrayInsert',
      'arrayMove',
...
var propsToNotUpdateFor = [].concat(Object.keys(_actions['default']), [
  'array',
  'asyncErrors',
  'initialValues',
  'syncErrors',
    ...
    return function(WrappedComponent) {
      var Form =
        ...
        (function(_React$Component) {
          ...
          function Form() {
              ...
              if (!_this.destroyed) {
                ...
                if (_destroyOnUnmount || forceUnregisterOnUnmount) {
                  ...
                  if (!_this.fieldCounts[name]) {
                    ...
                    _this.lastFieldValidatorKeys = _this.lastFieldValidatorKeys.filter(
                      function(key) {
                        return key !== name
                      }
                    )
            ...
            _this.getFieldList = function(options) {
              ...
              if (options) {
                ...
                if (options.excludeUnregistered) {
                  keySeq = keySeq.filter(function(name) {
                    return (
                      getIn(registeredFields, "['" + name + "'].count") !== 0
                    )
                  })
                }
              }
            ...
            _this.generateValidator = function() {
              ...
              return Object.keys(validators).length
                ? (0, _generateValidator['default'])(validators, structure)
                : undefined
            }
            ...
            _this.generateWarner = function() {
              ...
              return Object.keys(warners).length
                ? (0, _generateValidator['default'])(warners, structure)
                : undefined
            }
            ...
            _this.asyncValidate = function(name, value, trigger) {
              ...
              var fieldNeedsValidation = function fieldNeedsValidation() {
                var fieldNeedsValidationForBlur =
                  asyncBlurFields &&
                  name &&
                  ~asyncBlurFields.indexOf(name.replace(/\[[0-9]+\]/g, '[]'))
                var fieldNeedsValidationForChange =
                  asyncChangeFields &&
                  name &&
                  ~asyncChangeFields.indexOf(name.replace(/\[[0-9]+\]/g, '[]'))
                var asyncValidateByDefault = !(
              ...
              if (asyncValidate) {
                ...
                if (
                  ...
                  return (0, _asyncValidation['default'])(
                    function() {
            ...
            _this.submit = function(submitOrEvent) {
              ...
              if (
                !submitOrEvent ||
                (0, _silenceEvent['default'])(submitOrEvent)
              ) {
          ...
          _proto.updateSyncErrorsIfNeeded = function updateSyncErrorsIfNeeded(
            nextSyncErrors,
            nextError,
            lastSyncErrors
          ) {
            ...
            if (
              ...
              (!_plain['default'].deepEqual(lastSyncErrors, nextSyncErrors) ||
                !_plain['default'].deepEqual(error, nextError))
            ) {
              updateSyncErrors(nextSyncErrors, nextError)
            }
          }

          _proto.clearSubmitPromiseIfNeeded = function clearSubmitPromiseIfNeeded(
            nextProps
          ) {
          ...
          _proto.shouldErrorFunction = function shouldErrorFunction() {
            ...
            var shouldValidateOverridden =
              shouldValidate !== _defaultShouldValidate['default']
            var shouldErrorOverridden =
              shouldError !== _defaultShouldError['default']
            ...
            if (validate || fieldLevelValidate) {
              ...
              if (shouldError(validateParams)) {
                ...
                var _merge2 = (0, _merge4['default'])(
                  ...
                  nextSyncErrors = (0,
                  _objectWithoutPropertiesLoose2['default'])(_merge2, [
                    '_error'
                  ])
          ...
          _proto.updateSyncWarningsIfNeeded = function updateSyncWarningsIfNeeded(
            nextSyncWarnings,
            nextWarning,
            lastSyncWarnings
          ) {
            ...
            if (
              ...
              (!_plain['default'].deepEqual(
                lastSyncWarnings,
                nextSyncWarnings
              ) ||
                !_plain['default'].deepEqual(warning, nextWarning))
            ) {
            ...
            if (warn || fieldLevelWarn) {
              ...
              if (shouldWarn(validateParams)) {
                ...
                var _merge3 = (0, _merge4['default'])(
                  ...
                  nextSyncWarnings = (0,
                  _objectWithoutPropertiesLoose2['default'])(_merge3, [
                    '_warning'
                  ])
          ...
          _proto.shouldComponentUpdate = function shouldComponentUpdate(
            ...
            var _config$immutableProp = config.immutableProps,
              immutableProps =
                _config$immutableProp === void 0 ? [] : _config$immutableProp // if we have children, we MUST update in React 16
          ...
          _proto.render = function render() {
            ...
            var propsToPass = (0, _extends2['default'])(
              {},
              propNamespace
                ? ((_ref = {}), (_ref[propNamespace] = reduxFormProps), _ref)
                : reduxFormProps,
              rest
            )
            ...
            var _reduxForm = (0, _extends2['default'])({}, this.props, {
              getFormState: function getFormState(state) {
                return getIn(
                  _this3.props.getFormState(state),
                  _this3.props.form
                )
              },
              asyncValidate: this.asyncValidate,
            ...
            return (0, _react.createElement)(
              _ReduxFormContext.ReduxFormContext.Provider,
              {
                value: _reduxForm,
      ...
      Form.displayName =
        'Form(' + (0, _getDisplayName['default'])(WrappedComponent) + ')'
      ...
      Form.propTypes = {
        ...
        immutableProps: _propTypes['default'].arrayOf(
          _propTypes['default'].string
        ),
        initialValues: _propTypes['default'].oneOfType([
      ...
      var connector = (0, _reactRedux.connect)(
        function(state, props) {
          ...
          var syncErrors =
            getIn(formState, 'syncErrors') || _plain['default'].empty

          var syncWarnings =
            getIn(formState, 'syncWarnings') || _plain['default'].empty
        ...
        function(dispatch, initialProps) {
          ...
          var boundArrayACs = (0, _mapValues2['default'])(
            arrayActions,
            bindForm
          )
          ...
          var computedActions = (0, _extends2['default'])(
            {},
            connectedFormACs,
            boundArrayACs,
            {
      ...
      var ConnectedForm = (0, _hoistNonReactStatics['default'])(
        connector(Form),
        WrappedComponent
      )
      ...
      var WithContext = (0, _hoistNonReactStatics['default'])(
        (0, _ReduxFormContext.withReduxForm)(ReduxForm),
        WrappedComponent
      )
