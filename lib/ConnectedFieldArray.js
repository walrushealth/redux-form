...
var _createFieldArrayProps = _interopRequireDefault(
  require('./createFieldArrayProps')
)
  ...
  var ConnectedFieldArray =
    ...
    (function(_Component) {
        ...
        if (thisValue && nextValue) {
          ...
          if (
            ...
            (nextProps.rerenderOnEveryChange &&
              thisValue.some(function(val, index) {
      ...
      _proto.render = function render() {
        ...
        var props = (0, _createFieldArrayProps['default'])(
          structure,
          name,
          _reduxForm.form,
