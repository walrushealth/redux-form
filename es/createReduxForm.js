...
var arrayInsert = importedActions.arrayInsert,
  ...
  formActions = _objectWithoutPropertiesLoose(importedActions, [
    'arrayInsert',
    'arrayMove',
    'arrayPop',
    'arrayPush',
...
var propsToNotUpdateFor = [].concat(Object.keys(importedActions), [
  'array',
  'asyncErrors',
  'initialValues',
  'syncErrors',
        ...
        (function(_React$Component) {
            ...
            if (validate || fieldLevelValidate) {
              ...
              if (shouldError(validateParams)) {
                ...
                var _merge2 = _merge(
                  ...
                  nextSyncErrors = _objectWithoutPropertiesLoose(_merge2, [
                    '_error'
                  ])
            ...
            if (warn || fieldLevelWarn) {
              ...
              if (shouldWarn(validateParams)) {
                ...
                var _merge3 = _merge(
                  ...
                  nextSyncWarnings = _objectWithoutPropertiesLoose(_merge3, [
                    '_warning'
                  ])
          ...
          _proto.render = function render() {
            ...
            var _this$props12 = this.props,
              ...
              rest = _objectWithoutPropertiesLoose(_this$props12, [
                'anyTouched',
                'array',
                'arrayInsert',
                'arrayMove',
        ...
        (function(_React$Component2) {
          ...
          _proto2.render = function render() {
            var _this$props13 = this.props,
              ...
              rest = _objectWithoutPropertiesLoose(_this$props13, [
                'initialValues'
              ])
